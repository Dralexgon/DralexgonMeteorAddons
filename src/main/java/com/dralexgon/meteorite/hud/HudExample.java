package com.dralexgon.meteorite.hud;
...
public class HudExample extends HudElement {
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(Meteorite.HUD_GROUP, "example", "HUD element example.", HudExample::new);
